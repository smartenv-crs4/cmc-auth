 ...
 * @apiParam {Object} AdminDefaultUser Administrator Administrator default user dictionary
 * @apiParam {String} AdminDefaultUser.email email Administrator default user email
 * @apiParam {String} AdminDefaultUser.password password Administrator default user password
 * @apiParam {String="admin"} AdminDefaultUser.type type Administrator default user type *
 ...
 * @apiParam {String} apiGwAuthBaseUrl API gateway base URL(mandatory if a gateway is used in the architecture)
 ...
 * @apiParam {String} tokenLF.value=7  value the amount of unit you want to add
 *
 */
